...
public class Main {
    ...
    public static void main(String[] args) {
	 // Write your code here
        System.out.println("Welcome Back Amit Kaushik");
     /* Variables
     Just Like:
        -Water - Bucket
        -Masala - box
     ...
     System.out.println(name + " from\n " + channel);
        ...
        System.out.println(name.contains("Ami"));
...
//        // For each loop
        ...
        // Try - Catch
        String [] cars1 = {"Maruti Harry", "Maruti", "Suzuki", "Innova", "Ford Titanium"};
